...
Class Precios
{
    ...
    public function listar($MARCA_PROD,$MARCA_VEHI,$MODELO_VEHI,$FAMILIA,$RUC,$VENDEDOR,$GENERAL){
        ...
        if(!empty($MARCA_PROD)){
            ...
            $like_MARCA_PROD="MARCA_PROD like '%%'";
        }
        ...
        if(!empty($MARCA_VEHI)){
            ...
            $like_MARCA_VEHI="MARCA_VEHI like '%%'";
        }
        ...
        if($MARCA_PROD==""  && $MARCA_VEHI==""  &&  $MODELO_VEHI==""  &&  $FAMILIA=="" ){
            ...
            if((int)$resp->CONTADOR<2){
                ...
                PRECIO_ESPECIAL,
                CANT_MATRIZ,
                PRECIO_ESPECIAL_IVA FROM VI_LISTA_PRECIOS where $like_MARCA_PROD and $like_MARCA_VEHI  and MODELO_VEHI like '%$MODELO_VEHI%' and ltrim(rtrim(SUBLINEA)) like '%$FAMILIA%' and CANT_MATRIZ >0";
    ...
    public function listar2($MARCA_PROD,$MARCA_VEHI,$MODELO_VEHI,$FAMILIA,$RUC,$VENDEDOR,$GENERAL){
        ...
        if($MARCA_PROD==""  && $MARCA_VEHI==""  &&  $MODELO_VEHI==""  &&  $FAMILIA=="" ){
            ...
            if($GENERAL=='CARROCERIA'){
                ...
                PRECIO_ESPECIAL,
                CANT_MATRIZ,
                PRECIO_ESPECIAL_IVA FROM VI_LISTA_PRECIOS WHERE RTRIM(LTRIM(SUBLINEA)) in('COLISIÓN - CARROCERIA','ACCESORIOS - ACCESORIOS','ACCESORIOS - AIRE ACONDICIONADO','COLISIÓN - FAROS','COLISIÓN - RADIADORES') and CANT_MATRIZ >0
                ...
                PRECIO_ESPECIAL,
                CANT_MATRIZ,
                PRECIO_ESPECIAL_IVA FROM VI_LISTA_PRECIOS WHERE RTRIM(LTRIM(SUBLINEA)) IN
				('MOTOR - MOTOR DIESEL',
				...
				'DESGASTE - FRENO',
				'DESGASTE - SUSPENSIÓN',
				'DESGASTE - TRANSMISIÓN',
				'ELÉCTRICO - CABLES BUJÍA',
				'ELÉCTRICO - ELÉCTRICOS VARIOS',
				'MANTENIMIENTO - ADITIVOS',
				'MANTENIMIENTO - BANDAS',
				'MANTENIMIENTO - BUJÍAS',
				'MANTENIMIENTO - FILTROS',
				'MANTENIMIENTO - PLUMAS'
				) and CANT_MATRIZ >0
                ORDER BY DESCRIPCION ASC";
                ...
                PRECIO_ESPECIAL,
                CANT_MATRIZ,
                PRECIO_ESPECIAL_IVA FROM VI_LISTA_PRECIOS where $like_MARCA_PROD and $like_MARCA_VEHI  and MODELO_VEHI like '%$MODELO_VEHI%' and RTRIM(LTRIM(SUBLINEA)) like '%$FAMILIA%' and CANT_MATRIZ >0
                ORDER BY DESCRIPCION ASC";
