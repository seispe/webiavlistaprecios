...
<html>
  <head>
    ...
    <link href="../public/LOADING/loading.css" rel="stylesheet"/>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-mini"><b></b>IAV</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>IAV</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="#">
                <i class="fa fa-tasks"></i> <span>Precios</span>
              </a>
            </li>
